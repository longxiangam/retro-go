...
#define RG_SCREEN_VISIBLE_AREA      {0, 12, 0, 92}
...
#define RG_GAMEPAD_GPIO_MAP {\
    ...
    {RG_KEY_SELECT, .num = GPIO_NUM_15, .pullup = 1, .level =0},\
    {RG_KEY_START,  .num = GPIO_NUM_16, .pullup = 1, .level =0},\
    {RG_KEY_MENU,   .num = GPIO_NUM_17, .pullup = 1, .level =0},\
    {RG_KEY_OPTION, .num = GPIO_NUM_18, .pullup = 1, .level =0},\
    {RG_KEY_A,      .num = GPIO_NUM_38, .pullup = 1, .level =0},\
...
#define RG_GPIO_LCD_MOSI            GPIO_NUM_2
