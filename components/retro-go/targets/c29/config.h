...
#define RG_GAMEPAD_GPIO_MAP {\
    {RG_KEY_LEFT,   .num = GPIO_NUM_30, .pullup = 1, .level = 0},\
    {RG_KEY_RIGHT,  .num = GPIO_NUM_31, .pullup = 1, .level = 0},\
    {RG_KEY_UP,     .num = GPIO_NUM_28, .pullup = 1, .level = 0},\
    {RG_KEY_DOWN,   .num = GPIO_NUM_29, .pullup = 1, .level = 0},\
    ...
    {RG_KEY_Y,      .num = GPIO_NUM_36, .pullup = 1, .level = 0},\
    {RG_KEY_L,      .num = GPIO_NUM_53, .pullup = 1, .level = 0},\
    {RG_KEY_R,      .num = GPIO_NUM_54, .pullup = 1, .level = 0},\
}
